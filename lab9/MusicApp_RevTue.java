...
public class MusicApp_RevTue {
    public static void main(String args[]){
        ...
        System.out.println("6 - Sort the playlists");
        ...
        while (choice1 != 7){
            ...
            if (choice1 == 1){
                Playlist_RevTue p = new Playlist_RevTue();
                playlists.add(p);
                ...
                for (Playlist_RevTue p : playlists){
                ...
                System.out.println("Sorted Playlists");
                Collections.sort(playlists, Collections.reverseOrder());
                for (Playlist_RevTue p : playlists){
                    System.out.println(p);
                }
            }
